...
export class NcsIframeManager {
  private handshakeParent: HandshakeParent<
  ...
  async initialize(): Promise<
    HandshakeParent<typeof signerOutboundEvents, typeof signerInboundEvents>
  > {
    ...
    const iframeElement = await this.createInvisibleIFrame(
      iframeUrl.toString()
    );
